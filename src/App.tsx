...
function App({ onLeagueReady }: { onLeagueReady?: () => void } = {}) {
  ...
  useEffect(() => {
    if (localStorage.getItem('openfutbol_update_notifs') !== '1') return;
    const check = async () => {
      try {
            ...
            <div className="of-tools">
              ...
              <div className="of-tools-grid">
                ...
                <button onClick={() => setView('BACKUP')} className="of-tool of-tool-pink" title="Idioma, sonido, packs y copias de seguridad">
                  <svg viewBox="0 0 24 24" className="of-tool-ico" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" aria-hidden="true">
