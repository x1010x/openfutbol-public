                ...
                <>
                  <div className="flex justify-between items-center mb-4 bg-vga-black p-2 border border-vga-white">
                    <div className="flex items-center gap-2 justify-center min-w-0 flex-1">
                      <TeamCrest colors={homeTeam?.colors} size="sm" title={homeTeam?.name} />
                    ...
                    <div className="flex items-center gap-2 justify-center min-w-0 flex-1">
                      ...
                      <TeamCrest colors={awayTeam?.colors} size="sm" title={awayTeam?.name} />
                    </div>
                  </div>
                  <button
            ...
            <div className="bg-vga-black border-2 border-vga-gray vga-panel-inset p-4 mb-2">
              <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
                <div className="flex items-center gap-3 justify-end min-w-0">
                  ...
                  <TeamCrest colors={match.homeTeam.colors} size="lg" title={match.homeTeam.name} />
                </div>
                ...
                <div className="flex items-center gap-3 justify-start min-w-0">
                  <TeamCrest colors={match.awayTeam.colors} size="lg" title={match.awayTeam.name} />
